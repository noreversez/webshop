...
export default function LineFloatingButton() {
  ...
  return (
    ...
    >
      ...
      >
        <path d="M24 10.304c0-5.369-5.383-9.738-12-9.738-6.616 0-12 4.369-12 9.738 0 4.814 4.269 8.846 10.036 9.608.391.084.922.258 1.057.592.122.296.08.761.038 1.054l-.164 1.02c-.046.282-.234 1.134 1.011.605 1.246-.528 6.702-3.957 9.176-6.776 1.89-2.167 2.846-4.148 2.846-6.103z"/>
      </svg>
    </a>
  )
}
