...
export default function LineFloatingButton() {
  ...
  return (
    ...
    >
      ...
      >
        <path fill="white" d="M247.9 8C111 8 0 98.6 0 210.4c0 100.2 78.5 183.7 185.3 199.9 8.5 1.8 20.1 5.5 23.2 12.6 2.8 6.4 2.2 16.4.8 22.8-1.5 6.7-9.8 38.6-11.9 47-.6 2.4-1.2 5.9-1.2 5.9s-1.8 11.2 9.5 5.2c11.3-6 60.9-33.1 83.1-49.2 28.5-20.7 59.5-35.8 89.2-56.7 66.8-46.9 117.9-115.8 117.9-187.5C495.9 98.6 384.8 8 247.9 8z"/>
        <text x="248" y="255" font-family="Arial, Helvetica, sans-serif" font-weight="900" font-size="130" fill="#00B900" text-anchor="middle" dominant-baseline="middle" letter-spacing="4">LINE</text>
      </svg>
    </a>
  )
}
